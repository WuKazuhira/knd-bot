...
def slogan(texts: List[str] = Args(6)):
    ...
    def draw(pos: Tuple[float, float, float, float], text: str):
        frame.draw_text(pos, text, max_fontsize=40, min_fontsize=20, allow_wrap=True, halign="center")
...
def wakeup(text: str = RegexArg("text"), arg=NoArg()):
    ...
    try:
        frame.draw_text((310, 270, 460, 380), text, max_fontsize=90, min_fontsize=50, halign="center")
        frame.draw_text(
            (50, 610, 670, 720), f"{text}起来了", max_fontsize=110, min_fontsize=70, halign="center"
        )
    except ValueError:
        return
    return frame.save_jpg()
...
def psyduck(texts: List[str] = Args(2)):
    ...
    params = [
        ...
        ("right", ((13, 0), (143, 27), (125, 113), (0, 83)), (298, 23)),
        ("right", ((13, 0), (143, 27), (125, 113), (0, 83)), (298, 30)),
